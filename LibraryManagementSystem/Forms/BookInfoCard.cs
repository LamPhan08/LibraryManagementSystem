    ...
    public partial class BookInfoCard : Form
    {
        ...
        private void BookInfoCard_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                label_author.Text = "Author: " + database.Rows[0][3].ToString();
                label_quantity.Text = "Quantity: " + database.Rows[0][4].ToString();
                label_genre.Text = "Genre: " + database.Rows[0][5].ToString();
